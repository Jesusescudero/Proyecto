...
<form class="form" action="/SistemaBordadoA/index?clase=controladorlogin&metodo=insertempleados" method="POST" id="Registro">
...
<div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="text" id="usu" name="usu" placeholder="User" required>
    </div>
    <div class="form-group">
    ...
    <input type="password" id="pass2" placeholder="Confirmar Password" required>
    </div>
    <div class="form-group">
