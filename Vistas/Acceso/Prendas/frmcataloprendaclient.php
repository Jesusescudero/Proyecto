...
<?php
              ...
              ?>
              <div >
              <a href="/SistemaBordadoA/index?clase=controladorprenda&metodo=RopaDetalleclien&idP=<?php echo $fila['prendas_id']; ?> "><img src="data:image/jpeg;base64, <?php echo base64_encode($fila['Imagen']); ?>" ></a>
              <br>
